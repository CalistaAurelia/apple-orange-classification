...
with st.sidebar:
    ...
    st.markdown("**Model:** Custom CNN (V2)")
    ...
    st.divider()
    st.caption(
        "Model versi perbaikan (V2). "
        "Accuracy: 82.73% | F1 Score: 0.8288. "
        "Regularisasi (L2, SpatialDropout, Dropout 0.5) diperkuat dan "
        "learning rate diturunkan untuk mengatasi overfitting & bias pada V1."
    )
...
if uploaded_file is not None:
    ...
    if predict_clicked:
        ...
        # (lihat cell arsitektur CNN V2 di notebook), jadi di sini TIDAK boleh
